#!/usr/bin/env python3
"""Recupera el logo principal exacto desde HTML históricos autocontenidos.

La recuperación es byte-preserving: exige dos fuentes independientes con el
mismo PNG, valida estructura y dimensiones y solo escribe el archivo cuando se
usa ``--apply``. No redibuja, recolorea, recorta, optimiza ni deriva variantes.
"""
...
class EmbeddedLogoError(RuntimeError):
    """La recuperación no satisface el contrato de Marca Maestra."""
