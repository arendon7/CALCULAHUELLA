...
def build_implementation_plan(
    ...
    *,
    ...
    phases: list[tuple[str, str, str, str, str, list[str], int]] = [
        ...
        ("P3", "Datos y evidencias", "Ejecutar el plan de datos", "Solicitar, cargar, normalizar y validar datos y soportes por sede, fuente y periodo.", "/captura-guiada", ["Plan de datos", "Evidencias", "Control de cobertura"], 55),
        ...
        ("P5", "Cierre e informe", "Aprobar y reportar", "Cerrar el periodo, generar memoria técnica, informe ejecutivo y recomendaciones.", "/entrega-profesional", ["Cierre aprobado", "Memoria de cálculo", "Informe ejecutivo"], 92),
...
def ensure_demo_product_intelligence(session: Session) -> dict[str, int]:
    """Create auditable profiles, assessments and plans for all demo companies."""
    specs: dict[str, dict[str, Any]] = {
        ...
        "Café Sierra Verde": {
            "profile": {
                "company_size": "Mediana",
                "business_model": "Producción, beneficio y comercialización de café especial con operación agrícola y logística de exportación.",
                "sector_subsector": "Agroindustria cafetera",
                "operating_description": "Finca productiva, beneficiadero, bodega y transporte contratado con estacionalidad de cosecha.",
                "countries_count": 1,
                "countries": ["Colombia"],
                "facility_types": ["Unidad productiva agrícola", "Planta de beneficio", "Bodega"],
                "core_processes": ["Cultivo", "Fertilización", "Beneficio húmedo", "Secado", "Almacenamiento", "Exportación"],
                "energy_sources": ["Electricidad de red", "Diésel"],
                "fleet_profile": "Maquinaria agrícola y transporte de producto principalmente contratado.",
                "refrigerants_profile": "Equipos menores sin impacto material identificado en el screening inicial.",
                "waste_profile": "Pulpa, mucílago y residuos ordinarios del beneficio con aprovechamiento parcial.",
                "wastewater_profile": "Aguas mieles y corrientes del beneficio con control operativo.",
                "agriculture_land_use_profile": "Fertilización nitrogenada y manejo de suelo en predios productivos.",
                "key_materials": ["Fertilizantes", "Empaques", "Combustibles", "Café pergamino"],
                "supplier_profile": "Proveedores agrícolas, transportadores y operadores logísticos con información heterogénea.",
                "reporting_drivers": ["Compradores internacionales", "Gestión de finca", "Estrategia de reducción"],
                "climate_goals": ["Reducir intensidad por kilogramo de café", "Mejorar eficiencia de secado", "Optimizar transporte"],
                "current_data_systems": ["Registros de finca", "Excel", "Facturas", "Guías de transporte"],
                "inventory_history": "Primer inventario estructurado",
                "data_availability": "Media",
                "evidence_readiness": "Parcial",
                "reporting_frequency": "Mensual",
                "assurance_ambition": "Preparación para revisión limitada",
                "inventory_owner": "Coordinación de sostenibilidad",
                "executive_sponsor": "Gerencia comercial",
                "source": "Caso demo Iteración 11",
            },
            "assessment": {
        ...
        "Ruta Norte Logística": {
            "profile": {
                "company_size": "Mediana",
                "business_model": "Transporte terrestre, almacenamiento y distribución nacional con flota propia y terceros.",
                "sector_subsector": "Transporte y logística",
                "operating_description": "Patios de flota, centros logísticos, cadena de frío y operación subcontratada.",
                "countries_count": 1,
                "countries": ["Colombia"],
                "facility_types": ["Centro logístico", "Patio de flota", "Bodega"],
                "core_processes": ["Despacho", "Transporte", "Mantenimiento", "Almacenamiento", "Cadena de frío"],
                "energy_sources": ["Diésel", "Gasolina", "Electricidad de red"],
                "fleet_profile": "Flota pesada propia y red de transportadores contratados con telemetría parcial.",
                "refrigerants_profile": "Equipos de cadena de frío con balance anual de recargas.",
                "waste_profile": "Aceites, llantas, residuos de mantenimiento y residuos ordinarios.",
                "wastewater_profile": "Lavado de vehículos y servicios sanitarios.",
                "agriculture_land_use_profile": "No aplica.",
                "key_materials": ["Combustibles", "Llantas", "Lubricantes", "Repuestos"],
                "supplier_profile": "Transportadores terceros, talleres y proveedores de combustible con distintos niveles de trazabilidad.",
                "reporting_drivers": ["Clientes corporativos", "Eficiencia operativa", "Renovación de flota"],
                "climate_goals": ["Reducir consumo por tonelada-kilómetro", "Controlar refrigerantes", "Aumentar telemetría"],
                "current_data_systems": ["TMS", "ERP", "Telemetría", "Excel"],
                "inventory_history": "Serie histórica parcial",
                "data_availability": "Alta",
                "evidence_readiness": "Media",
                "reporting_frequency": "Mensual",
                "assurance_ambition": "Preparación para verificación limitada",
                "inventory_owner": "Dirección de operaciones",
                "executive_sponsor": "Gerencia general",
                "source": "Caso demo Iteración 11",
            },
            "assessment": {
                "desired_scopes": "Alcances 1, 2 y 3 avanzado",
                "objective": "Eficiencia operativa y requisitos de clientes",
                "urgency": "Normal",
                "deadline_months": 6,
            },
        },
        "Hotel Bosque Azul": {
            "profile": {
                "company_size": "Mediana",
                "business_model": "Alojamiento, alimentos, eventos y servicios turísticos para clientes nacionales y corporativos.",
                "sector_subsector": "Servicios y hotelería",
                "operating_description": "Hotel principal y centro administrativo con energía, GLP, refrigeración, residuos y traslados contratados.",
                "countries_count": 1,
                "countries": ["Colombia"],
                "facility_types": ["Hotel", "Oficina administrativa"],
                "core_processes": ["Alojamiento", "Cocina", "Lavandería", "Climatización", "Eventos", "Gestión de residuos"],
                "energy_sources": ["Electricidad de red", "GLP"],
                "fleet_profile": "Traslados de huéspedes y proveedores principalmente contratados.",
                "refrigerants_profile": "Sistemas de aire acondicionado y refrigeración con balance anual documentado.",
                "waste_profile": "Residuos orgánicos de cocina, reciclables y ordinarios con certificados de gestor.",
                "wastewater_profile": "Consumo y vertimiento sanitario monitoreado mediante facturación.",
                "agriculture_land_use_profile": "No aplica.",
                "key_materials": ["Alimentos", "Productos de limpieza", "Textiles", "GLP"],
                "supplier_profile": "Proveedores de alimentos, lavandería, transporte y gestión de residuos.",
                "reporting_drivers": ["Clientes corporativos", "Comité directivo", "Posicionamiento sostenible"],
                "climate_goals": ["Energía solar", "Reducción de desperdicio", "Eficiencia en climatización"],
                "current_data_systems": ["PMS hotelero", "Facturación", "Excel", "Registros de mantenimiento"],
                "inventory_history": "Inventario completo aprobado",
                "data_availability": "Alta",
                "evidence_readiness": "Alta",
                "reporting_frequency": "Mensual",
                "assurance_ambition": "Listo para revisión independiente",
                "inventory_owner": "Coordinación de sostenibilidad",
                "executive_sponsor": "Gerencia general",
                "source": "Caso demo Iteración 11",
            },
            "assessment": {
                "desired_scopes": "Alcances 1, 2 y 3 priorizado",
                "objective": "Reporte ejecutivo y diferenciación comercial",
                "urgency": "Normal",
                "deadline_months": 3,
            },
        },
